...
| Quiz      | Syllabus | 
| :---        |:----:   | 
| Quiz 1      |  data pipeline, database paradigm, key value, columnar    | 
| Quiz 2   |relational db, document db |
| Quiz 3   | graph db, data warehouse, hadoop |
| Quiz 4   | kafka, spark |
| Quiz 5  | tableau hands on | 
| Quiz 6  | clustering, data preprocessing |
